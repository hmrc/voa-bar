...
class EbarsClientV2 @Inject() (
  ...
  private val loginUrl: URL           = url"$eBarsBaseUrl/ebars_dmz_pres_ApplicationWeb/Welcome.do"
  private val xmlFileUploadURL: URL   = url"$eBarsBaseUrl/ebars_dmz_pres_ApplicationWeb/uploadXmlSubmission"
